...
public class BuyerSpeakFragment extends BaseFragment  implements SwipeRefreshLayout.OnRefreshListener,RefreshLayout.OnLoadListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        swipeLayout.setColorSchemeResources(R.color.color_bule2,
                ...
                R.color.color_bule2,
                R.color.color_bule3);
        swipeLayout.setOnRefreshListener(BuyerSpeakFragment.this);
        swipeLayout.setOnLoadListener(BuyerSpeakFragment.this);
